...
&nbsp;<asp:TextBox ID="TextBox2" runat="server" TextMode="Password" CssClass="mdl-textfield__label"></asp:TextBox>
      ...
      <asp:Button ID="Button1" runat="server" Text="Giriş Yap" CssClass="sign-in-btn mdl-button mdl-js-ripple-effect mdl-js-button mdl-button--raised mdl-button--colored" style="left: 0px; bottom: 0" OnClick="Button1_Click" />
 </div>
